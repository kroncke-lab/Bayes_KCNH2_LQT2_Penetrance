...
for (variant in cohort.data$var) {
  if (!is.na(match(variant, d$var))) {
     cohort.data[cohort.data$var == variant, c("lqt2_penetranceEstimate_EM","alpha", "beta", "lqt2_lit", "unaff_lit", "total_carriers_lit")] <- d[d$var == variant, c("p_mean_w", "alpha", "beta", "lqt2", "unaff", "total_carriers")]
  }
}
